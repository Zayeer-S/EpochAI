...
class ConfigLoader:
    ...
    def _lazy_database_init(cls):
        if cls._db_connection is None:
            ...
            try:
                ...
                cls._logger.info(f"Database components initialized for ConfigLoader")
    ...
    def get_uncollected_configs_by_type(
        ...
        try:
            collection_configs = cls._collection_configs_dao.get_uncollected_grouped_by_language(collection_type)
            ...
            cls._logger.info(f"Retrieved uncollected {collection_type} configs for {len(result)}")
            return result
    ...
    def get_collection_status_summary(cls) -> Dict[str, Any]:
        ...
        try:
            ...
            cls._logger.info(f"Retrieved collection status summary from database")
            return status
    ...
    def get_combined_wikipedia_config(cls) -> Dict[str, Any]:
        ...
        try:
            yaml_config = cls.get_wikipedia_collector_yaml_config()
            ...
            return cls.get_wikipedia_collector_yaml_config()
    ...
    def test_database_connection(cls) -> bool:
        ...
        try:
            cls._lazy_database_init()
            return cls.db_connection.test_connection()
        except Exception as general_error:
