...
class CollectedContentTypesDAO:
    ...
    def create_content_type(
        ...
        try:
            ...
            self.logger.error(
                f"Error creating collected content type '{collected_content_type_name}': {general_error}",
            )
            return None
    ...
    def get_by_name(
        ...
        try:
            ...
            self.logger.error(
                f"Error getting collected content type by name '{collected_content_type_name}': {general_error}",  # noqa
            )
            return None
